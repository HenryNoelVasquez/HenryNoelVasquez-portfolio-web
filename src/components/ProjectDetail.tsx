    ...
    const fetchProject = () => {
      ...
      const projectsData: Project[] = [
        ...
        },
        {
          ...
          images: [
            new URL('../assets/aicg/1.jpg', import.meta.url).href,
            new URL('../assets/aicg/2.jpg', import.meta.url).href,
            new URL('../assets/aicg/3.jpg', import.meta.url).href,
            new URL('../assets/aicg/4.jpg', import.meta.url).href,
            new URL('../assets/aicg/5.jpg', import.meta.url).href,
            new URL('../assets/aicg/6.jpg', import.meta.url).href,
            new URL('../assets/aicg/7.jpg', import.meta.url).href,
            new URL('../assets/aicg/8.jpg', import.meta.url).href,
            new URL('../assets/aicg/9.jpg', import.meta.url).href,
            new URL('../assets/aicg/10.jpg', import.meta.url).href,
            new URL('../assets/aicg/11.jpg', import.meta.url).href,
            new URL('../assets/aicg/12.jpg', import.meta.url).href,
            new URL('../assets/aicg/13.jpg', import.meta.url).href,
          ],
